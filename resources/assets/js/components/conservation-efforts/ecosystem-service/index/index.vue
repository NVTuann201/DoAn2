<template>
  <page-filter
    titleFilter="Dịch vụ hệ sinh thái"
    titleSearch="Dịch vụ hệ sinh thái"
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/ecosystem-service/data",
      detailUrl: "/search/ecosystem-service/",
      categoryUrl: "/search/ecosystem-service/category",
      mapUrl: "/search/ecosystem-service/map",
      category,
      type,
      year,
    };
