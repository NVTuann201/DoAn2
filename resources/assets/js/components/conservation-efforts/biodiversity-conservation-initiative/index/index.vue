<template>
  <page-filter
    :titleFilter="
      $t('conservation-efforts.biodiversity-conservation-initiative.title')
    "
    :titleSearch="
      $t('conservation-efforts.biodiversity-conservation-initiative.title')
    "
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/biodiversity-conservation-initiative/data",
      detailUrl: "/search/biodiversity-conservation-initiative/",
      categoryUrl: "/search/biodiversity-conservation-initiative/category",
      mapUrl: "/search/biodiversity-conservation-initiative/map",
      category,
      type,
      year,
    };
