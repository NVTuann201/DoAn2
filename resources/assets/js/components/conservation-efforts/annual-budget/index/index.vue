<template>
  <page-filter
    :titleFilter="$t('conservation-efforts.annual-budget.title')"
    :titleSearch="$t('conservation-efforts.annual-budget.title')"
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/annual-budget/data",
      detailUrl: "/search/annual-budget/",
      categoryUrl: "/search/annual-budget/category",
      mapUrl: "/search/annual-budget/map",
      category,
      type,
      year,
    };
