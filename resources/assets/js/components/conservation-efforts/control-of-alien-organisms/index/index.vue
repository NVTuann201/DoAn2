<template>
  <page-filter
    :titleFilter="$t('conservation-efforts.control-of-alien-organisms.title')"
    :titleSearch="$t('conservation-efforts.control-of-alien-organisms.title')"
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/control-of-alien-organisms/data",
      detailUrl: "/search/control-of-alien-organisms/",
      categoryUrl: "/search/control-of-alien-organisms/category",
      mapUrl: "/search/control-of-alien-organisms/map",
      category,
      type,
      year,
    };
