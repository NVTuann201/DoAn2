<template>
  <page-filter
    :titleFilter="$t('conservation-efforts.international-cooperation.title')"
    :titleSearch="$t('conservation-efforts.international-cooperation.title')"
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/international-cooperation/data",
      detailUrl: "/search/international-cooperation/",
      categoryUrl: "/search/international-cooperation/category",
      mapUrl: "/search/international-cooperation/map",
      category,
      type,
      year,
      selection,
