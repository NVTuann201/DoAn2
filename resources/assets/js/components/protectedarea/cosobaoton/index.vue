<template>
  <page-filter
    :titleFilter="$t('nbds_lang.submenu_conservation_infrastructure')"
    :titleSearch="$t('nbds_lang.submenu_conservation_infrastructure_desc')"
  ...
  >
    <template v-slot:extra-filter>
      <div class="filter-group ng-isolate-scope">
        ...
        <filter-choose
          :title="$t('nbds_lang.conservation_type')"
          v-model="filterBehavior"
          :options="optionBehavior"
        >
        ...
        <filter-choose
          :title="$t('nbds_lang.protected_areas.gov_type')"
          :route_suggest="gettopgovtypesofprotectedareas"
          field_name="gov_type"
          v-model="filter_gov_types"
        ></filter-choose>

        <filter-choose
          :title="$t('nbds_lang.conservation_type_organization')"
          v-model="filterTypeOrganization"
          :options="optionsTypeOrganization"
        >
          <template v-slot:name-filter="{ item }">
            {{ item.name }}
          </template>
...
export default {
  ...
  data: function () {
    return {
      ...
      filterEndangered: [],
      filterSource: [],
      filterTypeOrganization: [],
      optionBehavior: [
        { id: 1, name: "Vườn động vật" },
        { id: 2, name: "Vườn thực vật" },
        { id: 2, name: "Cơ sở cứu hộ" },
      ],
      optionsTypeOrganization: [
        { id: 1, name: "Cơ sở cứu hộ loài hoang dã" },
        { id: 2, name: "Cơ sở lưu giữ giống cây trồng" },
        { id: 3, name: "Cơ sở lưu giữ giống vật nuôi" },
        { id: 4, name: "Cơ sở lưu giữ vi sinh vật và nấm" },
        {
          id: 5,
