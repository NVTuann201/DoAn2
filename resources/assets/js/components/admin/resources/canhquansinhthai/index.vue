      ...
      <div class="right-aside">
        <div class="d-flex">
          <div style="flex: 1; font-size: 18px; font-weight: bold">
            Danh khu cảnh quan sinh thái quan trọng
          </div>
          <div class="d-flex">
            <input
              class="form-control"
...
export default {
  ...
  methods: {
    showXoa(data) {
      this.contentDelete =
        "Bạn có chắc chắn muốn xóa khu cảnh quan sinh thái " +
        data.ten +
        " không?";
      this.idDelete = data.id;
      this.confirmDelete = true;
      this.delLink = "admin/khucanhquansinhthai/delete/";
    },
    xoaDuLieu() {
      axios
    ...
    showFormAdd() {
      window.location.href = "/admin/khucanhquansinhthai/add";
    },
    showFormEdit(data) {
      window.location.href = "/admin/khucanhquansinhthai/edit/" + data.id;
    },
    getData() {
      axios
        .get(env.endpointhttp + "admin/khucanhquansinhthai/get", {
          params: {
            page: this.page,
            search: this.search,
    ...
    showXoaBoLoc() {
      if (
        this.filter.tinh_trang_id == null &&
        this.filter.do_quan_trong_id == null
      ) {
        return false;
      } else return true;
    },
    ...
    getChiSo() {
      axios
        .get(env.endpointhttp + "admin/khucanhquansinhthai/chiso")
        .then((res) => {
