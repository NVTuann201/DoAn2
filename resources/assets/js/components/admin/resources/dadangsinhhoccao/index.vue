      ...
      <div class="right-aside">
        <div class="d-flex">
          <div style="flex: 1; font-size: 18px; font-weight: bold">
            Danh sách khu vực đa dạng sinh học cao
          </div>
          <div class="d-flex">
            <input
              class="form-control"
            ...
            >
              <thead>
                <tr class="footable-header">
                  ...
                  <th style="display: table-cell">Cơ quan ban hành</th>
...
export default {
  ...
  methods: {
    showXoa(data) {
      ...
      this.delLink = "admin/khuvucdadangsinhhoccao/delete/";
    },
    xoaDuLieu() {
      axios
    ...
    showFormAdd() {
      window.location.href = "/admin/khuvucdadangsinhhoccao/add";
    },
    showFormEdit(data) {
      window.location.href = "/admin/khuvucdadangsinhhoccao/edit/" + data.id;
    },
    getData() {
      axios
        .get(env.endpointhttp + "admin/khuvucdadangsinhhoccao/get", {
          params: {
            page: this.page,
            search: this.search,
    ...
    showXoaBoLoc() {
      if (this.filter.tinh_trang_id == null) {
        return false;
      } else return true;
    },
    deleteSearchFilter() {
    ...
    getChiSo() {
      axios
        .get(env.endpointhttp + "admin/khuvucdadangsinhhoccao/chiso")
        .then((res) => {
