  ...
  <div class="white-box p-0">
    ...
    <div style="padding: 25px">
      <div class="c-flex">
        ...
        <div class="d-flex container-line">
          <div class="line-form">
            <label class="form-label">Quyết định thành lập/Giấy phép</label>
          ...
          <div class="line-form" style="width: 65%">
            <div class="c-flex">
              <div class="d-flex">
                <label style="flex: 1">Đính kèm văn bản </label>
                <div>
...
export default {
  ...
  methods: {
    back() {
      window.location.href = "/admin/cosobaoton";
    },
    getData() {
      ...
      this.loaiHinhToChucSelect = Object.assign(
        {},
        this.data.loai_hinh_to_chuc
      );
      this.quanLySelect = Object.assign({}, this.data.quan_ly);
      this.quanHuyenSelect = Object.assign({}, this.data.quan_huyen);
      if (this.data.files) {
        this.form.files = [...JSON.parse(this.data.files)];
      }
      this.form.status = this.form.status == 'Designated' ? 'Được công nhận' : 'Đang đề xuất'
    ...
    add() {
      this.$validator.validateAll().then((validate) => {
        ...
        if (validate) {
          ...
          axios
            .post(env.endpointhttp + "admin/cosobaoton/edit", this.form)
            .then((response) => {
              if (response.data.message == 'Done') {
                this.typeNotification = 2;
                this.textNotification = "Cập thành công";
