      ...
      <div class="right-aside">
        <div class="d-flex">
          <div style="flex: 1; font-size: 18px; font-weight: bold">
            Danh sách khu dự trữ sinh quyển
          </div>
          <div class="d-flex">
            <input
              class="form-control"
...
export default {
  ...
  methods: {
    showXoa(data) {
      this.contentDelete =
        "Bạn có chắc chắn muốn xóa khu dự trữ sinh quyển " +
        data.ten +
        " không?";
      this.idDelete = data.id;
      this.confirmDelete = true;
      this.delLink = "admin/khudutrusinhquyen/delete/";
    },
    xoaDuLieu() {
      axios
    ...
    showFormAdd() {
      window.location.href = "/admin/khudutrusinhquyen/add";
    },
    showFormEdit(data) {
      window.location.href = "/admin/khudutrusinhquyen/edit/" + data.id;
    },
    getData() {
      axios
        .get(env.endpointhttp + "admin/khudutrusinhquyen/get", {
          params: {
            page: this.page,
            search: this.search,
    ...
    getChiSo() {
      axios
        .get(env.endpointhttp + "admin/khudutrusinhquyen/chiso")
        .then((res) => {
