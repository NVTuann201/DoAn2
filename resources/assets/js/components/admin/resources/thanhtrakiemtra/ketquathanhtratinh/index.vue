      ...
      <div class="right-aside">
        <div class="d-flex">
          <div style="flex: 1; font-size: 18px; font-weight: bold">
            Danh sách kết quả thanh tra tỉnh
          </div>
          <div class="d-flex">
            <input
              class="form-control"
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <div>
                      {{
                        item.tinh_thanh ? item.tinh_thanh.name_vietnamese : ""
                      }}
                    </div>
                  </td>
...
export default {
  ...
  methods: {
    showXoa(data) {
      ...
      this.delLink = "admin/ketquathanhtratinh/";
    },
    xoaDuLieu() {
      axios
    ...
    showFormAdd() {
      window.open("/admin/ketquathanhtratinh/create", "_blank");
    },
    showFormEdit(id) {
      window.open(`/admin/ketquathanhtratinh/${id}/edit`, "_blank");
    },

    getData() {
      axios
        .get(env.endpointhttp + "admin/ketquathanhtratinh/get", {
          params: {
            page: this.page,
