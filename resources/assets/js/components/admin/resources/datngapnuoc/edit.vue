      ...
      <div class="c-flex">
        ...
        <div class="d-flex container-line">
          ...
          <div class="line-form">
            ...
            <input v-model="form.doi_tuong_bao_ve" class="form-control" />
          </div>
        </div>
    ...
    quanHuyenSelect: [
      {
        id: 26,
        name: "Hanoi",
        name_vietnamese: "Hà Nội",
        administrative_code: "VN.HI",
        region_id: 3,
        created_at: "2014-10-23 12:35:21.526",
        updated_at: "2014-10-23 12:35:21.526",
      },
    ],
    ...
    add() {
      this.$validator.validateAll().then((validate) => {
        ...
        if (validate) {
          ...
          axios
            .post(
              env.endpointhttp + "admin/datngapnuocquantrong/edit",
              this.form
            )
            .then(() => {
