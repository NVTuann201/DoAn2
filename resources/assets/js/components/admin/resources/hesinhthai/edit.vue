        ...
        <div class="d-flex container-line">
          ...
          <div class="line-form">
            ...
            <multiselect v-model="diaDiemSelect" :options="danhmucs.dia_diem" :searchable="true" track-by="id"
              label="orig_name" placeholder="Địa điểm" :show-labels="false">
                ...
                <b-card>
                  <table v-if="hstRung">
                    ...
                    <tr v-for="(item, index) in loaiHinhRung" :key="item.id">
                      ...
                      <td>{{ item.name }}</td>
                      <td>
                        <input type="number" class="form-control" placeholder="ha" v-model="form[item.model]" />
                      </td>
                    </tr>
                  </table>
                  <table v-if="hstNuoc">
          ...
          <div class="d-flex full-width" style="justify-content: space-between">
            ...
            <div>
              <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal"
                data-bs-placement="top" title="Cập nhật" @click="update" :disabled="disableButton">
...
export default {
  ...
  data: () => ({
    ...
    form: {
      ...
      bat_dau: null,
      ket_thuc: null,
      dien_tich_rung_dac_dung: null,
      dien_tich_rung_tu_nhien: null,
      dien_tich_rung_trong: null,
      dien_tich_rung_chuyen_doi: null,
      dien_tich_dnn_chuyen_doi: null,
      dien_tich_rung_ngap_nuoc: null,
      dien_tich_song_ngoi: null,
      dien_tich_dat_mat_nuoc: null,
      dien_tich_rung_phong_ho: null,
      dien_tich_rung_trong_moi: null,
  ...
  methods: {
    ...
    getData() {
      ...
      this.heSinhThaiSelect = Object.assign({}, this.data.he_sinh_thai);
      this.phanLoaiSelect = Object.assign({}, this.data.phan_loai);
      this.diaDiemSelect = Object.assign({}, this.data.dia_diem);
      ...
      this.quanHuyenSelect = this.data.quan_huyen;
      this.changeHeSinhThai(false);
    },
    resetForm() {
      this.heSinhThaiSelect = null;
      this.phanLoaiSelect = null;
      this.nguonGocSelect = null;
      this.diaDiemSelect = null;
      this.phanLoaiRungSelect = null;
    ...
    changeHeSinhThai(change = true) {
      if (change) {
        this.form.phan_loai_id = null;
        this.form.do_phu = null;
        this.form.tru_luong = null;
        this.form.don_vi_tinh_tru_luong = null;
        this.form.dien_tich_rung_trong_moi = null;
        this.form.dien_tich_moi_chet = null;
        this.form.dien_tich_rung_phong_ho = null;
        this.form.dien_tich_rung_fsc = null;
        this.form.dien_tich_rung_dvtm = null;
        this.form.dien_tich_rung_dac_dung = null;
        this.form.dien_tich_rung_tu_nhien = null;
        this.form.dien_tich_rung_trong = null;
        this.form.dien_tich_rung_chuyen_doi = null;
        this.form.dien_tich_dnn_chuyen_doi = null;
        this.form.dien_tich_rung_ngap_nuoc = null;
        this.form.dien_tich_song_ngoi = null;
        this.form.dien_tich_dat_mat_nuoc = null;
        this.phanLoaiSelect = null;
        this.nguonGocSelect = null;
        this.diaDiemSelect = null;
      }
    ...
    update() {
      this.$validator.validateAll().then((validate) => {
        ...
        if (validate) {
          ...
          axios
            .post(env.endpointhttp + "admin/hesinhthai/edit", this.form)
            .then((response) => {
