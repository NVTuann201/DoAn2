                  ...
                  <td>
                    <div style="white-space: initial">
                      <div>
                        ...
                        <div>Tên khoa học: {{ item.ten_khoa_hoc }}</div>
                      </div>
                    </div>
                  </td>
                  <td>{{ item.phan_loai ? item.phan_loai.name : "" }}</td>
                  <td>{{ item.nguy_co ? item.nguy_co.name : "" }}</td>
...
export default {
  ...
  methods: {
    showXoa(data) {
      ...
      this.delLink = "admin/sinhvatngoailai/delete/";
    },
    xoaDuLieu() {
      axios
    ...
    showFormAdd() {
      window.location.href = "/admin/sinhvatngoailai/add";
    },
    showFormEdit(data) {
      window.location.href = "/admin/sinhvatngoailai/edit/" + data.id;
    },
    getData() {
      axios
        .get(env.endpointhttp + "admin/sinhvatngoailai/get", {
          params: {
            page: this.page,
            search: this.search,
            phan_loai_id: this.filter.phan_loai_id,
            nguy_co_id: this.filter.nguy_co_id,
          },
        })
        .then((res) => {
    ...
    getChiSo() {
      axios
        .get(env.endpointhttp + "admin/sinhvatngoailai/chiso")
        .then((res) => {
