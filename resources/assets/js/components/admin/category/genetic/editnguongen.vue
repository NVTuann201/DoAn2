<template>
  <div class="white-box p-0 editgen">
    <tabs>
      <tab name="Cập nhật nguồn gen">
        ...
        <div style="font-size: 18px; font-weight: 500; flex: 1">
          ...
          <span style="padding-left: 10px"> Cập nhật dữ liệu nguồn gen</span>
        </div>
        <button
          type="button"
            ...
            >
              ...
              <div class="d-flex container-line">
                <div class="line-form">
                  ...
                  <span v-show="errors.has('maqg')" class="help is-danger" style="color: red">Nhóm gen không
                    thể bỏ trống</span>
                </div>
                <div class="line-form">
                  ...
                  <input class="form-control" v-model="form.ma_so_tinh" placeholder="Mã số nguồn gen tỉnh" name="matinh"
                    v-validate="'max:255'" />
                  <span v-show="errors.has('matinh')" class="help is-danger" style="color: red">Nhóm gen không
                    thể bỏ trống</span>
                </div>
                <div class="line-form">
              ...
              <div class="d-flex container-line">
                ...
                <div class="line-form">
                  ...
                  <input class="form-control" type="number" v-model="form.so_luong_vat_lieu_di_truyen_luu_giu"
                    placeholder="Số lượng Vật liệu di truyền lưu giữ" />
                </div>
              </div>
            ...
            <div class="d-flex" style="justify-content: space-between">
              ...
              <div>
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal"
                  data-bs-placement="top" title="Cập nhật" @click="add" :disabled="disableButton">
                  <i class="fas fa-check"></i> Cập nhật
                </button>
              </div>
            </div>
...
export default {
  components: { ValidationProvider, Multiselect, NoiLuuGiu },
  props: ["danhmucs", "data"],
  data: () => ({
  ...
  methods: {
    ...
    getData() {
      ...
      this.nhomGenSelect = Object.assign({}, this.data.nhom_gen);
      this.loaiGenSelect = Object.assign({}, this.data.loai_gen);
      this.suDungSelect = Object.assign({}, this.data.su_dung);
      this.genQuyHiemSelect = Object.assign({}, this.data.gen_quy_hiem);
      this.tinhTrangLuuGiuSelect = Object.assign(
        {},
        this.data.tinh_trang_luu_tru
      );
      this.tinhTrangNghienCuuSelect = Object.assign(
        {},
        this.data.tinh_trang_nghien_cuu
      );
      this.tinhTrangSuDungSelect = Object.assign(
        {},
        this.data.tinh_trang_su_dung
      );
      this.nguonGocVietNamSelect = Object.assign(
        {},
        this.data.nguon_goc_viet_nam
      );
      this.nguonGocDiaPhuongSelect = Object.assign(
        {},
        this.data.nguon_goc_dia_phuong
      );
      this.nguonGocCoSoSelect = Object.assign({}, this.data.nguon_goc_co_so);
      this.phuongThucLuuTruSelect = Object.assign(
        {},
        this.data.phuong_thuc_luu_giu
      );
      this.tinhTrangSelect = Object.assign({}, this.data.tinh_trang);
      this.genCoDieuKienSelect = Object.assign({}, this.data.gen_co_dieu_kien);
      this.triThucSelect = Object.assign({}, this.data.tri_thuc);
      this.noiLuuGiuSelect = [...this.data.noi_luu_gius];
      this.triThucSelect = null;
      if (this.data.tri_thuc_id && this.data.tri_thuc_id.length) {
        this.triThucSelect = this.danhmucs.tri_thuc_truyen_thong.filter(el => JSON.parse(this.data.tri_thuc_id).includes(el.id))
      }
    },
    changNhomGen() {
    ...
    setSeletFrom() {
      ...
      this.form.tinh_trang_su_dung_id = this.tinhTrangSuDungSelect
        ...
        : null;
      this.form.tri_thuc_id = this.triThucSelect ? this.triThucSelect.map(el => el.id) : null;
    ...
    add() {
      this.$validator.validateAll().then((validate) => {
        ...
        if (validate) {
          ...
          axios
            .post(env.endpointhttp + "admin/genetic/edit", this.form)
            .then((response) => {
    ...
    getSpecies(query = "") {
      ...
      window.LIT = setTimeout(() => {
        ...
        axios
          .get(env.endpointhttp + "admin/genetic/searchspecies?search=" + query)
          .then((response) => {
...
<style >
/* .editgen .tabs-component {
  margin: 4em 0;
} */
.editgen .tabs-component-tabs {
...
.editgen .tabs-component-tab:not(:last-child) {
...
.editgen .tabs-component-tab.is-active {
  color: #000;
}

.editgen .tabs-component-tab.is-disabled * {
  color: #cdcdcd;
