<template>
  <page-filter
    :titleFilter="$t('nbds_lang.submenu_biodiversity_conservation_initiative')"
    :titleSearch="$t('nbds_lang.submenu_biodiversity_conservation_initiative_desc')"
    ...
    <template v-slot:extra-filter>
      <div class="filter-group ng-isolate-scope">
        <filter-choose
          ...
          :options="[
            { id: 1, name: 'Thực hiện chính sách' },
            { id: 2, name: 'Hợp tác quốc tế' },
            { id: 2, name: 'Hoạt động tình nguyện' },
            { id: 2, name: 'Khác' },
          ]"
        >
