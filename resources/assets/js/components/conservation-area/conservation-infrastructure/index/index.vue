<template>
  <page-filter
    :titleFilter="$t('conservation-area.conservation-infrastructure.title')"
    :titleSearch="$t('conservation-area.conservation-infrastructure.title')"
...
export default {
  ...
  data: function () {
    return {
      searchUrl: "/search/conservation-infrastructure/data",
      detailUrl: "/search/conservation-infrastructure/",
      categoryUrl: "/search/conservation-infrastructure/category",
      mapUrl: "/search/conservation-infrastructure/map",
      category,
      type,
      mapListGetters: {
        legends: null,
