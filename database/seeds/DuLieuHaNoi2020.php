...
class DuLieuHaNoi2020 extends Seeder
{
    /**
    ...
    {
        //
        $myfile = fopen("database/seeds/data2020.json", "r");
        $files = json_decode(fread($myfile, filesize("database/seeds/data2020.json")));
        $data = $files->data;
        DB::beginTransaction();
