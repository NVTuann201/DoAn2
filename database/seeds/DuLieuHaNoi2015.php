...
class DuLieuHaNoi2015 extends Seeder
{
    /**
    ...
    {
        //
        $myfile = fopen("database/seeds/data2015.json", "r");
        $files = json_decode(fread($myfile, filesize("database/seeds/data2015.json")));
        $data = $files->data;
        DB::beginTransaction();
